...
// Parked here (underscore prefix = ignored by the App Router) while the
// active `loading.tsx` renders null. The skeleton is preserved in case we
// want to restore it once the LCP streaming issue is addressed upstream.
